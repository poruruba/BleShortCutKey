...
static const char* deviceName = "Esp32BleKeyboard";
static const char* manufacturerName = "Esp32Ble";
...
void Esp32BleKeyboard_begin(const char *p_deviceName, const char *p_manufacturerName, uint32_t passkey){
...
void Esp32BleKeyboard_sendKeys(uint8_t mod, const uint8_t *keys, uint8_t num_key){
  BLE2902* desc = (BLE2902*)input->getDescriptorByUUID(BLEUUID((uint16_t)0x2902));
